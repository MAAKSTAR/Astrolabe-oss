...
class ExovonSidebarProvider {
    ...
    constructor(_context, _brainCoordinator) {
...
`;
                    ...
                    const orchestrator = new AgentOrchestrator_1.AgentOrchestrator(async (command) => {
                        ...
                        if (update.type === 'complete') {
                            ...
                            webviewView.webview.postMessage({ type: 'agentReasoning', text: update.text });
                        }
                        else if (update.type === 'finalAnswer') {
                            webviewView.webview.postMessage({ type: 'agentFinalAnswer', text: update.text });
                        }
...
//# sourceMappingURL=ExovonSidebarProvider.js.map