...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  ...
  setpath "product" "nameShort" "Astrolabe"
  setpath "product" "nameLong" "Astrolabe IDE"
  setpath "product" "applicationName" "astrolabe"
  setpath "product" "dataFolderName" ".astrolabe"
  setpath "product" "linuxIconName" "astrolabe"
  setpath "product" "quality" "stable"
  setpath "product" "urlProtocol" "astrolabe"
  setpath "product" "serverApplicationName" "astrolabe-server"
  setpath "product" "serverDataFolderName" ".astrolabe-server"
  setpath "product" "darwinBundleIdentifier" "com.exovon.astrolabe"
  setpath "product" "win32AppUserModelId" "Exovon.Astrolabe"
  setpath "product" "win32DirName" "Astrolabe"
  setpath "product" "win32MutexName" "astrolabe"
  setpath "product" "win32NameVersion" "Astrolabe"
  setpath "product" "win32RegValueName" "Astrolabe"
  setpath "product" "win32ShellNameShort" "Astrolabe"
  setpath "product" "reportIssueUrl" "https://github.com/MAAKSTAR/Astrolabe-oss/issues"
  setpath "product" "documentationUrl" "https://exovon.in/astrolabe"
